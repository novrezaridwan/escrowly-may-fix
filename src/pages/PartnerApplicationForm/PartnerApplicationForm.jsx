...
function PartnersInquiry() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Crypto Escrow Partner Application | Become an Escrowly.com Partner
        </title>
        <meta
          name="description"
          content="Apply to become an official Escrowly partner. Join our crypto escrow network as a partner and earn by helping users transact safely in digital deals."
        />
        <meta
          name="keywords"
          content="Escrowly partner signup, crypto escrow affiliate, become a partner with Escrowly, crypto escrow referral, escrow commission program, secure transaction partner, crypto escrow application"
        />
        <meta name="author" content="Escrowly Crypto Escrow Team" />
        <meta
          property="og:title"
          content="Partner with Escrowly.com | Earn as a Crypto Escrow Partner or Affiliate"
        />
        <meta
          property="og:description"
          content="Join the Escrowly.com partner program to help users complete safe crypto transactions. Apply today to become a partner or affiliate and start earning."
        />
        <meta property="og:image" content="https://escrowly.com/og-image.jpg" />
        <meta
          property="og:url"
          content="https://escrowly.com/partners-application-form"
        />
        ...
        <main className="main-content">
          <Breadcrumbs
            breadcrumbs={[
              ...
              {
                title: "Partners Application Form",
                url: "/partners-application-form",
              },
            ]}
          />
          ...
          <section className="section custom-class">
            ...
            <p>
              Become an Escrowly partner and offer trusted crypto escrow
              services.
            </p>
            <div className="card">
