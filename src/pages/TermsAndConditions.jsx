                ...
                <section className="section-blog-article">
                    <div className="container">
                        ...
                        <div className="blog-article-content">
                            ...
                            <ol>
                                <li>a. <Link to="/privacy-policy" className="font-weight-bold text-primary-custom"> Privacy Policy:</Link>{" "} It defines the processes to collect and utilize your data as well as protect your information.</li>
