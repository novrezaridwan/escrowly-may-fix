                            ...
                            <div className="row">
                                <div className="col col-left">
                                    ...
                                    <div className="blog-article-content">
                                        ...
                                        <img className="w-full h-auto my-4 rounded-lg" src="/images/escrowly-security2.webp" alt="Escrowly Crypto Escrow Security"/>
                                        ...
                                        <img className="w-full h-auto my-4 rounded-lg" src="/images/escrowly-vault.webp" alt="Escrowly Crypto Escrow Vault"/>
